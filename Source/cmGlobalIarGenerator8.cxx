...
#include "cmsys/Glob.hxx"
  ...
  //----------------------------------------------------------------------------
void cmGlobalIarGenerator::Project::CreateProjectFile8()
{
  ...
  std::string ccAllowList = subexpElimination + loopUnrolling +
    functionInlining + codeMotion + typeBasedAlias + staticClustering +
...
//----------------------------------------------------------------------------
void cmGlobalIarGenerator::Project::CreateDebuggerFile8()
{
